...
var app = (function () {
    ...
    function create_if_block(ctx) {
    	...
    	return {
    		c: function create() {
    			...
    			t1 = text(ctx.inCart);
    			t2 = text(" in cart)");
    			add_location(em, file, 114, 8, 2300);
    			attr(span, "class", "svelte-1ywc763");
    			add_location(span, file, 113, 6, 2284);
    		},
    ...
    function create_fragment(ctx) {
    	...
    	return {
    		c: function create() {
    			...
    			attr(img_1, "class", "svelte-1ywc763");
    			add_location(img_1, file, 101, 2, 1934);
    			attr(h3, "class", "title svelte-1ywc763");
    			add_location(h3, file, 102, 2, 1966);
    			attr(p, "class", "price svelte-1ywc763");
    			add_location(p, file, 103, 2, 1999);
    			attr(object, "aria-label", "shopping cart");
    			attr(object, "type", "image/svg+xml");
    			attr(object, "data", "img/svg/shopping-cart.svg");
    			attr(object, "class", "svelte-1ywc763");
    			add_location(object, file, 106, 6, 2102);
    			attr(button, "class", "svelte-1ywc763");
    			add_location(button, file, 105, 4, 2065);
    			attr(div0, "class", "button-group svelte-1ywc763");
    			add_location(div0, file, 104, 2, 2033);
    			attr(div1, "class", "item-card svelte-1ywc763");
    			add_location(div1, file, 100, 0, 1907);
    ...
    function create_fragment$1(ctx) {
    	...
    	return {
    		c: function create() {
    			...
    			attr(section, "class", "card-wrapper grid svelte-ij15qu");
    			add_location(section, file$1, 40, 0, 700);
    		},
    ...
    function create_if_block$1(ctx) {
    	...
    	return {
    		c: function create() {
    			div = element("div");
    			t = text(ctx.cart_sum);
    			attr(div, "class", "circle svelte-363j34");
    			add_location(div, file$2, 110, 8, 2059);
    		},
    ...
    function create_fragment$2(ctx) {
    	...
    	return {
    		c: function create() {
    			...
    			ul = element("ul");
    			li0 = element("li");
    			li0.textContent = "SvelteCommerce";
    			t1 = space();
    			li1 = element("li");
    			img = element("img");
    			t2 = space();
    			if (if_block) if_block.c();
    			attr(li0, "class", "svelte-363j34");
    			add_location(li0, file$2, 101, 4, 1781);
    			attr(img, "class", "shopping-cart svelte-363j34");
    			attr(img, "aria-label", "shopping cart");
    			attr(img, "alt", "Checkout");
    			attr(img, "src", "img/svg/checkout.svg");
    			attr(img, "height", "34px");
    			add_location(img, file$2, 103, 6, 1866);
    			attr(li1, "class", "svelte-363j34");
    			add_location(li1, file$2, 102, 4, 1830);
    			attr(ul, "class", "svelte-363j34");
    			add_location(ul, file$2, 100, 2, 1771);
    			attr(header, "class", "svelte-363j34");
    			add_location(header, file$2, 99, 0, 1759);
    ...
    function create_fragment$3(ctx) {
    	...
    	return {
    		c: function create() {
    			...
    			attr(img_1, "alt", ctx.name);
    			attr(img_1, "class", "svelte-1mtjrp3");
    			add_location(img_1, file$3, 121, 2, 2140);
    			attr(h3, "class", "title svelte-1mtjrp3");
    			add_location(h3, file$3, 123, 4, 2215);
    			attr(p0, "class", "price svelte-1mtjrp3");
    			add_location(p0, file$3, 124, 4, 2250);
    			attr(button0, "class", "add svelte-1mtjrp3");
    			add_location(button0, file$3, 126, 6, 2320);
    			attr(p1, "class", "svelte-1mtjrp3");
    			add_location(p1, file$3, 127, 6, 2388);
    			attr(button1, "class", "subtract svelte-1mtjrp3");
    			add_location(button1, file$3, 128, 6, 2410);
    			attr(object, "aria-label", "remove");
    			attr(object, "type", "image/svg+xml");
    			attr(object, "data", "img/svg/cancel.svg");
    			attr(object, "class", "svelte-1mtjrp3");
    			add_location(object, file$3, 130, 8, 2538);
    			attr(button2, "class", "remove svelte-1mtjrp3");
    			add_location(button2, file$3, 129, 6, 2483);
    			attr(div0, "class", "count svelte-1mtjrp3");
    			add_location(div0, file$3, 125, 4, 2293);
    			attr(div1, "class", "item-meta-data svelte-1mtjrp3");
    			add_location(div1, file$3, 122, 2, 2181);
    			attr(div2, "class", "item-grid svelte-1mtjrp3");
    			add_location(div2, file$3, 120, 0, 2113);
    ...
    function create_else_block_1(ctx) {
    	...
    	return {
    		c: function create() {
    			...
    			attr(button, "class", "checkout svelte-1worxli");
    			add_location(button, file$4, 71, 4, 1447);
    			dispose = listen(button, "click", ctx.checkout);
    		},
    ...
    function create_if_block$2(ctx) {
    	...
    	function select_block_type_1(ctx) {
    		if (ctx.checkedOut) return create_if_block_1;
    ...
    function create_else_block(ctx) {
    	...
    	return {
    		c: function create() {
    			...
    			attr(p, "class", "empty-message svelte-1worxli");
    			add_location(p, file$4, 65, 6, 1285);
    		},
    ...
    function create_if_block_1(ctx) {
    	...
    	return {
    		c: function create() {
    			...
    			attr(p, "class", "empty-message svelte-1worxli");
    			add_location(p, file$4, 63, 6, 1205);
    		},
    ...
    function create_fragment$4(ctx) {
    	...
    	return {
    		c: function create() {
    			...
    			t_1 = space();
    			if_block.c();
    			add_location(h1, file$4, 60, 2, 1127);
    			attr(div, "class", "checkout-container svelte-1worxli");
    			add_location(div, file$4, 59, 0, 1091);
    		},
    ...
    function instance$3($$self, $$props, $$invalidate) {
      ...
      const checkout = () => {
        $$invalidate('checkedOut', checkedOut = true);
        cart.update(n => {
          return {};
        });
      };
